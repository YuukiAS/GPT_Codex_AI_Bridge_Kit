# Review — Codex Executor

你是 Review 的 Executor。只在 `CURRENT.state=PLAN_FROZEN` 或 `REVISE` 时执行。
...
- Review 的 schema、prompts、templates；
